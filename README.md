...
| [`build-knowledge-base`](skills/build-knowledge-base/SKILL.md) | Prepare your brand's knowledge base / agent context to hand to Boom (guided interview + own-site research) |
